...
const TextRotate = forwardRef<TextRotateRef, TextRotateProps>(
  (
    ...
    useEffect(() => {
      ...
      const delay =
        currentTextIndex === 0 && firstRotationInterval != null
          ? firstRotationInterval
          : rotationInterval;

      const timeoutId = setTimeout(next, delay);
      return () => clearTimeout(timeoutId);
    }, [next, rotationInterval, firstRotationInterval, auto, currentTextIndex]);
